...
async function fillIdentity() {
  ...
  await userEvent.type(screen.getByPlaceholderText("٨ أحرف على الأقل"), "Password1!");
  await userEvent.type(screen.getByPlaceholderText("أعد إدخال كلمة المرور"), "Password1!");
}
