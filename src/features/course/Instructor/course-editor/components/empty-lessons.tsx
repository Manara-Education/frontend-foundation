  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: "clamp(32px, 12vw, 64px) clamp(16px, 7vw, 32px)",
        minInlineSize: 0,
    ...
    >
      ...
      <h3 className="rs-longform" style={{ fontFamily: FONT, fontWeight: 700, fontSize: 17, color: "#1E2340" }}>
        لم تقم بإضافة أي دروس بعد
      </h3>
      <p className="rs-longform" style={{ fontFamily: FONT, fontSize: 13, color: "#9BA3C4", marginTop: 6, maxWidth: 300, lineHeight: 1.75 }}>
      ...
      <motion.button
        ...
        className="flex items-center gap-2 mt-7 rounded-2xl"
        style={{
