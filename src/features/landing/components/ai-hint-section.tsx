        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 60, alignItems: "center" }}>
          <FadeIn delay={0.1}>
            <div>
              ...
              <div style={{ marginTop: 28, padding: "20px 22px", borderRadius: 16, background: "#fff", border: `1px solid ${BORDER}`, display: "flex", gap: 6 }}>
                <div style={{ width: 3, borderRadius: 99, background: PRIMARY, flexShrink: 0 }} />
                <p style={{ fontFamily: FONT, fontSize: 13.5, color: TEXT_MUTED, lineHeight: 1.8, margin: "0 12px" }}>
          ...
          <FadeIn delay={0.2}>
            <div style={{ padding: "32px", borderRadius: 24, background: "#fff", border: `1px solid ${BORDER}`, boxShadow: "0 8px 40px rgba(78,91,146,0.1)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 20 }}>
                <div style={{ width: 36, height: 36, borderRadius: 10, background: `${PRIMARY}12`, color: PRIMARY, display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <p style={{ fontFamily: FONT, fontSize: 14.5, color: TEXT_MUTED, lineHeight: 1.85, margin: 0, borderRight: `2px solid ${PRIMARY}30`, paddingRight: 16 }}>
