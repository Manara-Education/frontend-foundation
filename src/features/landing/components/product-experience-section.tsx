  ...
  return (
    <section dir="rtl" style={{ paddingBlock: "clamp(72px, 10vw, 100px)", paddingInline: "clamp(16px, 4vw, 28px)", background: BG_SOFT }}>
      <div style={{ maxInlineSize: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(300px, 100%), 1fr))", gap: 48, alignItems: "center", marginTop: 60 }}>
          ...
          <FadeIn delay={0.2}>
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              {[
                ...
                <div key={title} style={{ display: "flex", gap: 16, alignItems: "flex-start", minInlineSize: 0 }}>
                  <div style={{ inlineSize: 40, blockSize: 40, borderRadius: 12, background: BG_SOFT, border: `1px solid ${BORDER}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>{icon}</div>
