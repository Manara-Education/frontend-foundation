...
export function VisionSection() {
  ...
  return (
    <section id="vision" dir="rtl" style={{ padding: "100px 28px", background: BG_SOFT }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(190px, 1fr))", gap: 16, marginTop: 56 }}>
          {principles.map(({ icon, title, desc }, i) => (
            <FadeIn key={title} delay={i * 0.08}>
              <div style={{ padding: "28px 22px", borderRadius: 20, background: "#fff", border: `1px solid ${BORDER}`, textAlign: "center" }}>
                <div style={{ width: 50, height: 50, borderRadius: 14, background: `${PRIMARY}10`, color: PRIMARY, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>{icon}</div>
