...
export function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" dir="rtl" style={{ padding: "100px 28px", background: BG }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 0, marginTop: 60 }}>
          {steps.map(({ n, title, desc }, i) => (
            <FadeIn key={n} delay={i * 0.1}>
              <div style={{ padding: "32px 24px", textAlign: "center" }}>
                <div style={{ width: 64, height: 64, borderRadius: 20, background: `linear-gradient(135deg, ${PRIMARY} 0%, #6172AC 100%)`, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px", fontFamily: FONT, fontWeight: 800, fontSize: 18, boxShadow: "0 6px 20px rgba(78,91,146,0.28)" }}>
                  {n}
                </div>
